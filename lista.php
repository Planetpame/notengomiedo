...
<h3> Do you think this institution is corrupt?</h3>
    <div class="radio">
      <label>
        <input type="radio" name="underwear1" value="1" required>
        Yes 
      </label>
    </div>
    <div class="radio">
      <label>
        <input type="radio" name="underwear1" value="0" required>
        No
      </label>
    </div>
  </div>
        ...
        <div class="form-group" align="center">
        <h4> Do you think this institution is efficient?</h4>
          <div class="radio">
          <label>
        <input type="radio" name="underwear2" value="1" required>
        Yes 
      </label>
      </div>
      <div class="radio" align="center">
        <label>
        <input type="radio" name="underwear2" value="0" required>
        No
       </label>
      </div>
     </div>
     <div class="form-group" align="center">
      <h4> Do you think this institution is effective?</h4>
      <div class="radio">
        <label>
          <input type="radio" name="underwear3" value="1" required>
          Yes 
        </label>
      </div>
      <div class="radio">
        <label>
          <input type="radio" name="underwear3" value="0" required>
          No
        </label>
      </div>
    </div>
    <div class="form-group" align="center">
    <h4> Do you think this institution is reliable?</h4>
      <div class="radio">
        <label>
         <input type="radio" name="underwear4" value="1" required>
          Yes 
        </label>
      </div>
      <div class="radio">
    ...
    <div class="page-header">
            ...
            <small>3. It is OK </small>
            <small>4. It is Great </small>
             <small>5. It is Good </small>
        </div>
